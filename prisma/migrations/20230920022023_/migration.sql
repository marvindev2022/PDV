...
-- CreateIndex
CREATE UNIQUE INDEX "veicles_plate_key" ON "veicles"("plate");
...
-- AddForeignKey
ALTER TABLE "veicles" ADD CONSTRAINT "veicles_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
